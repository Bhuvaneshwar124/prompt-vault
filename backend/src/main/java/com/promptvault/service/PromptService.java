...
public interface PromptService {
    ...
    PagedResponse<PromptResponse> searchPrompts(String search, String categorySlug, String tagSlug, String aiTool, int page, int size, String sortBy, String sortDir, String currentUsername);
